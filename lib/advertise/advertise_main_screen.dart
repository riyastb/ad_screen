  ...
  List<Branch> _dummyBranches() {
    return const [
      Branch(
        ...
        forexSellRate: 3.69,
        priorityCurrency: 1,
        tickerBannerDescription:
            'Welcome to Lari Exchange • Best rates guaranteed',
      ),
      Branch(
        id: 'D2',
        ...
        priorityCurrency: 1,
        tickerBannerDescription:
            'Zero commission on remittance • Limited time offer',
      ),
      Branch(
        id: 'D3',
  ...
  Future<void> _loadBranches() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        if (branches.isEmpty) {
          _logger.w(
              '⚠️ No branches returned from service. Using dummy fallback data.');
        }
